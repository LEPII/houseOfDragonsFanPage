    ...
    <section className="dnt_container">
      ...
      <div className="dnt_description" id="dnt_what_section">
        <div className="dnt_what_text">
          <h3> What Is It?</h3>
          <span>
            Coromoto 2020 is a non-profit organization of a group of committed
            lay people from the Catholic Church, whose mission is to strengthen
            the most vulnerable Venezuelan families in their needs for food and
      ...
      <div className="dnt_description" id="dnt_how_section">
        ...
        <span>
          With their website below, you can make a donation in money or products
          (flour, rice, sugar, beans, soy meat and pasta) and the Coromoto 2020
          team will take care of the distribution.
        </span>
      </div>
